function [F,J,DFnu,Jquad,Fext,Fphase,tensors] = ...
             FDFsymflextensor_ext_Hopf(x,nu,forcing,ref,solshape,symmetry,Jshape)
...
% Modified version of FDFsymflextensor_ext for Hopf bifurcation
...
J(1:end-1,end)=zeros(size(1i*wjac));
...
J(end,1:end-1)=zeros(size(1i*(refjac)')); 
